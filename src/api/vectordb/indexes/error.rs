...
impl Display for IndexesError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::FailedToGetAppEnv => write!(f, "Internal server error: Failed to get application environment"),
            Self::CollectionNotFound => write!(f, "Collection not found"),
            Self::FailedToCreateIndex(msg) => write!(f, "Failed to create index: {}", msg),
            Self::IndexAlreadyExists(index_type) => write!(f, "Index of type '{}' already exists for this collection. Delete it first.", index_type),
            Self::FailedToDeleteIndex(msg) => write!(f, "Failed to delete index: {}", msg),
            Self::InvalidIndexType(provided_type) => write!(f, "Invalid index type provided: '{}'. Expected 'dense' or 'sparse'.", provided_type),
